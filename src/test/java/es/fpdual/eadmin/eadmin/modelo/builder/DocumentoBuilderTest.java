...
//		documento1 =new DocumentoBuilder().conCodigo(1).conNombre("nombre").conFechaCreacion(null).conPublico(null).conEstadoDocumento(null).conFechaUltimaActualizacion(null).construir();
//	}
//	
//	@Test
